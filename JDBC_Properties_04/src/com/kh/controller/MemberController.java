...
public class MemberController {
	...
	public boolean loginMember(String inputMemberId, String inputMemberPw) {
		boolean isTrue = false;
		Member m = new MemberService().loginMember(inputMemberId, inputMemberPw);
		if(m == null) {
			new MemberMenu().displayFail("로그인에 실패되었습니다.");
		}else {
			new MemberMenu().displaySuccess("성공적으로 로그인되었습니다.");
			isTrue = true;
		}
		return isTrue;
	}
