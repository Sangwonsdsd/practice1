...
public class MemberMenu {
	...
	public void loginMenu() {
		System.out.println("\n==로그인관리==");
		if(mc.loginMember(inputMemberId(), inputMemberPw())) {
			mainMenu();
		}else {
			return;
		}
	...
	/**
	 * 회원 추가 창 (서브화면) 즉, 추가하고자 하는 회원의 정보를 입력 받아 회원을 추가요청하는 창
	 */
	 ...
	 * @param message : 조회 결과에대한 응답메세지
	 */
	public void displayNoData(String message) {
		System.out.println("\n" + message);
	}
	/**
	 * 조회서비스 요청 시 조회 결과가 여러행일 경우 사용자가 보게될 응답화면
	 * @param memberList : 출력할 member들이 담겨있는 list
	 */
